          ...
          <form onSubmit={handleSubmit}>
              <div className="section">
                <div className="fields-container">
                  ...
                  <Textfield type='text' label="Place name" placeholder='Enter place name' getInput={setPlaceName} />
                  <Textfield type='text' label="Category" placeholder='Enter place category' getInput={setCategory} />
                  <Textfield type='number' label="Price" placeholder='Enter ticket price' getInput={setPrice} />
                  <Textfield type='text' label="Description" placeholder='Enter place description' getInput={setDescription} />
                  <Textfield type='text' label="Location" placeholder='Enter place location' getInput={setLocation} />
                </div>
              </div>

    ...
    <div className="privacy-policy-container">
      ...
      <div ref={content} className="content-wrapper">
        ...
        <div>
          ...
          <p>- <i>Name</i></p>
          <p>- <i>Email</i></p>
          <p>- <i>Phone/mobile number</i></p>
          <p>- <i>Home/mailing address</i></p>
        </div>
        ...
        <div>
          ...
          <p>- <i>Sign up to receive updates from us via email or social media channels</i></p>
          <p>- <i>Use a mobile device or web browser to access our content</i></p>
          <p>- <i>Contact us via email, social media, or on any similar technologies</i></p>
          <p>- <i>When you mention us on social media</i></p>
        </div>
        ...
        <div>
          ...
          <p>When we collect and process personal information, and while we retain this information, we will protect it within commercially acceptable means to prevent loss and theft, as well as unauthorized access, disclosure, copying, use, or modification. Although we will do our best to protect the personal information you provide to us, we advise that no method of electronic transmission or storage is 100% secure, and no one can guarantee absolute data security. We will comply with laws applicable to us in respect of any data breach.</p>
        </div>
      </div>
    </div>
  )
